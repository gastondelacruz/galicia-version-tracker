      ...
      <div className="w-full max-w-lg space-y-16 animate-in fade-in-50 duration-700 bg-card border-2 border-border rounded-lg p-16 shadow-sm">
        ...
        <div>
          <Button
            ...
            size="lg"
            className="w-full h-14 bg-primary hover:bg-primary/90 text-primary-foreground text-base font-medium transition-all duration-300 hover:shadow-lg hover:scale-[1.02]"
          >
